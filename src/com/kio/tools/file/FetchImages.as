package com.kio.tools.file
{
	...
	public class FetchImages extends Sprite
	{						
		 ...
		 */
		public function FetchImages(width:Number = 1920, height:Number=1080,scaleMode:String = "stretch"):void
		{
			this.sequenceName = sequenceName;
			
			//directory = File.documentsDirectory.resolvePath("KIO/"+folderName+"/");
			directory = File.applicationDirectory.resolvePath("media");
